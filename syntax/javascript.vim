...
syntax region  jsFuncArgs        contained matchgroup=jsFuncParens start='(' end=')' contains=jsFuncArgCommas,jsFuncArgRest,jsComment,jsLineComment,jsStringS,jsStringD,jsNumber,jsFuncArgDestructuring,jsArrowFunction,jsParen,jsArrowFuncArgs,jsCallback nextgroup=jsFuncBlock keepend skipwhite skipempty
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink jsArguments            Type

  HiLink jsNodeGlobalObjects    Special
  HiLink jsCallback             Statement

  HiLink jsUseStrict            PreProc
