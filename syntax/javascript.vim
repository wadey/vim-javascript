...
syntax region  jsFuncArgs       contained matchgroup=jsFuncParens start='(' end=')' contains=jsFuncArgCommas,jsFuncArgRest,jsCallback nextgroup=jsFuncBlock keepend skipwhite skipempty
